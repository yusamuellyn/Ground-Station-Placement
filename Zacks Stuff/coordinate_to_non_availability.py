...
# Match all 12 monthly files in the same directory
pattern = os.path.join(script_dir, "MODAL2_M_CLD_FR_*_rgb_720x360.CSV")
...
output_df.to_csv(os.path.join(script_dir, "lat_long_non_availability.csv"))
